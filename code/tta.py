...
tta3_data = TestDataset(image_paths, tta3)
tta3_loader = DataLoader(
    tta3_data,
    shuffle=False
)
...
all_predictions = []
for i1,i2,i3,i4 in zip(loader,tta1_loader,tta2_loader,tta3_loader):
    with torch.no_grad():
        i1 = i1.to(device)
        i2 = i2.to(device)
        i3 = i3.to(device)
...
submission['ans'] = all_predictions
    ...
    # 제출할 파일을 저장합니다.
submission.to_csv(os.path.join(test_dir, 'submission_f_b4_1249_tta2.csv'), index=False)
